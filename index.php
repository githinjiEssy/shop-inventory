					...
					<div class="tab-content">
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form>
							  ...
							  <button type="button" id="addItem" class="btn btn-outline-success">Add Item</button>
							  <button type="button" id="updateItemDetailsButton" class="btn btn-outline-primary">Update</button>
							  <button type="button" id="deleteItem" class="btn btn-outline-danger">Delete</button>
						...
						<div id="itemImageTab" class="container-fluid tab-pane fade">
							...
							<form name="imageForm" id="imageForm" method="post">
							  ...
							  <br>
							  <button type="button" id="updateImageButton" class="btn btn-outline-primary">Upload Image</button>
							  <button type="button" id="deleteImageButton" class="btn btn-outline-danger">Delete Image</button>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  ...
					  <button type="button" id="addPurchase" class="btn btn-outline-success">Add Purchase</button>
					  <button type="button" id="updatePurchaseDetailsButton" class="btn btn-outline-primary">Update</button>
					  <button type="reset" class="btn">Clear</button>
					</form>
				  </div> 
				</div>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <button type="button" id="addVendor" name="addVendor" class="btn btn-outline-success">Add Vendor</button>
					  <button type="button" id="updateVendorDetailsButton" class="btn btn-outline-primary">Update</button>
					  <button type="button" id="deleteVendorButton" class="btn btn-outline-danger">Delete</button>
					  <button type="reset" class="btn">Clear</button>
					 </form>
				  </div> 
				</div>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  ...
					  <button type="button" id="addSaleButton" class="btn btn-outline-success">Add Sale</button>
					  <button type="button" id="updateSaleDetailsButton" class="btn btn-outline-primary">Update</button>
					 ...
					 <form> 
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  ...
						  <input type="text" class="form-control" id="customerDetailsCustomerDistrict" name="customerDetailsCustomerDistrict">
					  ...
					  <button type="button" id="addCustomer" name="addCustomer" class="btn btn-outline-success">Add Customer</button>
					  <button type="button" id="updateCustomerDetailsButton" class="btn btn-outline-primary">Update</button>
					  <button type="button" id="deleteCustomerButton" class="btn btn-outline-danger">Delete</button>
					  <button type="reset" class="btn">Clear</button>
					 </form>
				  </div> 
				</div>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="saleReportStartDate"   name="saleReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="saleReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="saleReportEndDate"   name="saleReportEndDate" readonly>
								  </div>
							  </div>
							...
							<form> 
							  <div class="form-row">
								  <div class="form-group col-md-3">
									...
									<input type="text" class="form-control datepicker" id="purchaseReportStartDate"   name="purchaseReportStartDate" readonly>
								  </div>
								  <div class="form-group col-md-3">
									<label for="purchaseReportEndDate">End Date</label>
									<input type="text" class="form-control datepicker" id="purchaseReportEndDate"   name="purchaseReportEndDate" readonly>
								  </div>
							  </div>
